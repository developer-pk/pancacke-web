...
import { Card, Checkbox, FormControlLabel, Button, CircularProgress } from '@material-ui/core';
...
<i className="icon-heart-empty"></i>
      ...
      >
        <DialogTitle id="alert-dialog-title">
          {'Remove ' +
            (tokeninfo.data.symbol ? tokeninfo.data.symbol : 'BNB ') +
            ' from Favourites'}
        </DialogTitle>
        <DialogContent>
          <DialogContentText id="alert-dialog-description">
            {'Are you sure you want to remove token address ' +
              (tokeninfo.data.address
                ? tokeninfo.data.address.substr(0, 30) + '...'
                : bnbToken.substr(0, 30) + '...') +
          ...
          <div className="alert_text2 text-center">
            ...
            <ValidatorForm onSubmit={handleLoginFormSubmit}>
              ...
              <div className="flex flex-wrap items-center mb-4">
                ...
                <Button className="capitalize" onClick={() => history.push('/signup')}>
                  Sign up
                </Button>
              </div>
              <Button
